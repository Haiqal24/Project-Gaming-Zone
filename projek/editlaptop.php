...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $stmt = $conn->prepare("SELECT * FROM `laptop` WHERE id=?");
...
<head>
    ...
    <title>GamingZone - Edit Laptop </title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 mb-5">
            <form action="code.php" method="post">
                ...
                <h2 class="text-center p-2 h-font">Edit Laptop Details for <?= htmlspecialchars($name ?? ''); ?></h2>
