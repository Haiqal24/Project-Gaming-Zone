...
<div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center text-white"> AMD RADEON Set PC !</h2>    
      ...
      <div class="card border-0 shadow" style="max-width: 600px; margin:auto;">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-evenly mb-1">
            <a href="orderamd.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-dark shadow-none">Buy Now</a>
          </div>                          
        </div>
      </div>
    </div>
