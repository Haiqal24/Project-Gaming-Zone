...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['image']["tmp_name"], $target_file)) {
          ...
          $sql = "INSERT INTO comps(name,price,cp,mb,gp,gbram,store,image) VALUES(?,?,?,?,?,?,?,?)";
    ...
    <body class="bg-white">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 bg-light mt-5 rounded shadow">
            <h2 class="text-center h-font p-2">AMD Radeon</h2>
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 mt-3 p-4 bg-light rounded">
          <a href="amdadmin.php" class="btn btn-primary btn-lg btn-block">Go to product page</a>
        </div>
      </div>
