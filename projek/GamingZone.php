      ...
      <div class="card border-5 shadow" style="max-width: 230px; margin:auto;">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-evenly mb-1">
            <button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" data-bs-target="#Modal"> more detail</button>
          </div>                          
        </div>
      </div>
    </div>
                ...
                <div class="col-lg-5 col-md-6 my-3 mx-5">
                    <div class="card border-0 shadow" style="max-width: 10000px; margin:auto;">
                        ...
                        <div class="card-body">
                          ...
                          <button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" data-bs-target="#Modal"> more detail
                            </button></a>
                          </div>                          
                        </div>
                    </div>
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-person-lines-fill fs-3 me-3"></i> Please Login or Register first
                        </h5>
                ...
                <div class="col-lg-5 col-md-6 my-3 mx-5">
                    ...
                    <br> 
                      ...
                      <button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" data-bs-target="#Modal"> more detail</button></a>
                          </div>                          
                        </div>
                    </div>
                    </div>
