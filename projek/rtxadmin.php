...
<div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center"> NVIDIA GEFORCE Set PC !</h2>    
    ...
    <div class="cog-2 col-md-0 my-4 mx-4  ">
      <div class="card border-0 shadow" style="max-width: 600px; margin:auto;">
        ...
        <div class="card-body">
          ...
          <a href="editrtx.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-warning shadow-none mx-2">Edit</a>

            <a href="orderadmin.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-success shadow-none">View</a>
          
          <form action="delete.php" method="post" style="display: inline;">
              <input type="hidden" name="delete_id" value="<?php echo htmlspecialchars($row['id']); ?>">
              <button type="submit" name="deletebtnn" class="btn btn-sm btn-outline-danger shadow-none mx-2" onclick="return confirm('Are you sure you want to delete this entry?')">Delete</button>
            </form>
    </div>                         
        </div>
      </div>
